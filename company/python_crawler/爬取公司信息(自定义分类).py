...
# 上传到数据库
def post_sjk(page,index, all_index, shop_url, shop_name, trade, address, lxr, phone, 固话):
    print(shop_name, trade, address, lxr, phone, 固话)
    ...
    for index,shop in enumerate(soup.find_all("div",attrs={"class": "biaoti"})[38:]):
        ...
        if shop_name == "八方资源网":pass
            ...
            if phone==""and 固话 == "":
                ...
                # fun: 上传到数据库
                post_sjk(page,index, all_index, shop_url, shop_name, trade, address, lxr, phone, 固话)
