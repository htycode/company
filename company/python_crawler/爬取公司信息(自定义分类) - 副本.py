...
# 上传到数据库
def post_sjk(page,index,all_index, phone, 固话, shop_url, shop_name, address):
...
all_index = 0
# 获取公司列表页_html
for page in range(5,200):
    url = 'https://www.b2b168.com/fuwu/chaoshibaihuobianlidian/l-{}.html'.format(page)
    ...
    for index,shop in enumerate(soup.find_all("div",attrs={"class": "biaoti"})):
        ...
        if shop_name == "八方资源网":pass
            ...
            if phone==""and 固话 == "":
                ...
                # fun: 上传到数据库
                post_sjk(page,index,all_index, phone, 固话, shop_url, shop_name, address)
